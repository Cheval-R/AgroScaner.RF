export const calculatorParamsContent = {
  // container calculator-params__wrapper calculator-params__wrapper--manual
  mainPage: `
        <table class="calculator-params__table gradation" data-table="first">
          <thead>
            <tr>
        ...
        <table class="calculator-params__table fertilizer" data-table="second">
          <thead>
            <tr>
        ...
        <table class="calculator-params__table field-info" data-table="third">
          <thead>
            <tr>
              <th>
                Площадь поля, га
  ...
  clientPage: `
        <table class="calculator-params__table field-info" data-table="first">
            <thead>
              <tr>
  ...
  <table class="calculator-params__table fertilizer" id="input-table"  data-table="second">
            <thead>
              <tr>
